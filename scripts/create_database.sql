...
/* create table ayat */
create table ayat(ayat_id int primary key, ayat_text nvarchar(max)not null collate Arabic_CI_AI_KS_WS, fk_surah_id int foreign key references surah(surah_id))
